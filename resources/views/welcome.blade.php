        ...
        <header class="container-fluid fixed-top">
            <nav class="navbar navbar-expand-lg bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand btn btn-light active" aria-current="page" href="/">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="navbar-brand btn btn-light " href="/student">Sudent-List</a>
                    </li>
    ...
    <!--NAVBAR END-->
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <a class="btn btn-primary mt-5" href="/student" style="float: right;">Go To Student Page --></a>
